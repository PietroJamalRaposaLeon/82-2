...
export default class RideScreen extends Component {
    ...
    handleTransaction = async () => {
        ...
        if (!transactionType) {
            ...
            var isEligible = await this.checkStudentEligibilityForBookIssue(useriId) ;
            ...
            var isEligible = await this.checkUserEligibilityForBikeReturn(userId,bikeId)
            if (isEligible) {
                var { bikeType, userName } = this.state;
    ...
    checkUserEligibilityForEndRide = async (bikeId, userId) => {
        ...
        transactionRef.docs.map(doc => {
            ...
            if (astBikeTransaction.userid == userId) {
                isUserEligible = true;
            } else {
                isUserEligible = false;
